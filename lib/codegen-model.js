...
var createModelProperties = function(swaggerModelProperties) {
	...
	//		modelProperties.push(Mustache.render(templatesVar, allowedEnumVar));
		} else {
...
//				modelProperties.push(Mustache.render(templatesVar, enumVar));
			} else {
				if (isArray(varEntry)) {
					varEntry.array=true;
					varEntry.initValue='[]';
...
//					modelProperties.push(Mustache.render(templateArray, varEntry));
				} else {
					if (varEntry.format === 'date-time') {
						varEntry.type = 'Date';
					}
//					modelProperties.push(Mustache.render(templatesVar, varEntry));
				}
			}
		}
...
var createModels = function(swagger, templateModel, templateEnum) {
	...
	var codeSet = [];
	var modelList = _.keys(swagger.models);
//	console.log(modelList);
	modelList.forEach(function(model) {
//		console.log(models[model]);
		var swagegerModelSpec = swagger.models[model];

		console.log('swagegerModelSpec');
		console.log(swagegerModelSpec);
