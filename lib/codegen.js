exports.CodeGen = function(className, swagger){
    ...
    var addMethod = function(path, op){
        var params = 'var body = undefined; var path = \'' + path + '\';\nvar qs = {};\nvar headers = {};';
        ...
        ' function(error, response, body){ if(error) { deferred.reject(error); } else if(response.statusCode >= 200 && response.statusCode <= 299) { deferred.resolve({ response: response, body: body }); } else { deferred.reject({ response: response, body: body });}});' +
