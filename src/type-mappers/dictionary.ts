...
export function makeDictionaryTypeSpec(
  swaggerType: SwaggerDictionary,
  swagger: Swagger
): DictionaryTypeSpec {
  const elementTypeSpec = convertType(
    swaggerType.additionalProperties,
    swagger
  );
  ...
  return {
    ...
    tsType: `{ [key: string]: ${elementTypeSpec.target ||
